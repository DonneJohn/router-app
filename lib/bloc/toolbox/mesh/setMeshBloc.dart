...
class SetMeshBloc implements BlocBase {
  final BehaviorSubject<CommonResponseModel> _subject =
      BehaviorSubject<CommonResponseModel>();

  setMesh(String status) {
    _doSetMesh(_subject, status);
  }

  Future<int> _doSetMesh(
    ...
    return await Future.value(CapacitiesService.getInstance().sendMessage(
        ...
        jsonEncode(
          CommonRequestModel(
            ...
            Parameter(Constant.mqttCmdTypeSetMesh,
