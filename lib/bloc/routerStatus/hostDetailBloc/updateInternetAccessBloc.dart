///
///Created by slkk on 2019/9/23/0023 15:27
///
import 'dart:convert';
...
class UpdateInternetAccessBloc extends BlocBase {
  final BehaviorSubject<CommonResponseModel> _subject =
      BehaviorSubject<CommonResponseModel>();

  Sink<CommonResponseModel> get inUpdateInternetAccess => _subject.sink;

  Stream<CommonResponseModel> get outUpdateInternetAccess => _subject.stream;

  updateInternetAccess(String host,
      {List<BlockList> whitelist, List<BlockList> blacklist}) {
    _doUpdateInternetAccess(_subject, host,
        whitelist: whitelist, blacklist: blacklist);
  }

  Future<int> _doUpdateInternetAccess(
    ...
    return await Future.value(CapacitiesService.getInstance().sendMessage(
        Constant.mqttCmdTypeUpdateInternetAccess,
