///
///Created by slkk on 2019/9/23/0023 13:08
///
import 'dart:convert';
...
class SetInternetAccessBloc extends BlocBase {
  final BehaviorSubject<CommonResponseModel> _subject =
      BehaviorSubject<CommonResponseModel>();

  Sink<CommonResponseModel> get inSetInternetAccess => _subject.sink;

  Stream<CommonResponseModel> get outSetInternetAccess => _subject.stream;

  setInternetAccess(String host, String type) {
    _doSetInternetAccess(_subject, host, type);
  }

  Future<int> _doSetInternetAccess(BehaviorSubject<CommonResponseModel> subject,
      String host, String type) async {
    return await Future.value(CapacitiesService.getInstance().sendMessage(
        Constant.mqttCmdTypeSetInternetAccess,
        ...
        jsonEncode(
          requestModel.CommonRequestModel(
            ...
            requestModel.Parameter(Constant.mqttCmdTypeSetInternetAccess,
